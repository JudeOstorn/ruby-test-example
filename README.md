...
n = 15                     # колличество случайных чисел в массиве
a = []
#n.times do
#  a << rand(100)          # массив из N случайных целых чисел
#end
a = (1..n).to_a # набор id баннеров. к примеру (Уникальны)
...
while i <= b
 if a != c[i]
   p a1 = a.shuffle           # or == p a = a.sort_by { rand } ==
   c << a1
 end
